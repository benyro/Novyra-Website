...
window.NOVYRA_I18N_MESSAGES = {
  en: {
    ...
    home: {
      ...
      testi1CiteHandle: "@feliciajoh",
      testi1CiteAvatarAlt: "Profile photo for Felicia (@feliciajoh) on TikTok",
    ...
    member: {
      ...
      compareTitle: "The difference between streaming without Novyra Agency and streaming with Novyra",
      compareSoloTitle: "WITHOUT NOVYRA AGENCY",
