...
window.NOVYRA_I18N_MESSAGES = {
  en: {
    ...
    bonus: {
      ...
      advanceLede: "Reach the diamond total for a tier to unlock that month’s add-on.",
      eliteTitle: "Elite",
      eliteMeta: "Track B · higher payouts, stricter minimums",
      eliteLede: "Same diamond steps as Advance, with larger bonus amounts and more days and hours required.",
      qualTitle: "Qualification",
      advQ1: "Minimum <strong>18</strong> days / month",
      advQ2: "Minimum <strong>60</strong> hours / month",
      ...
      pushLabel: "1M+ push",
      pushMint: "Over 1M points → extra <strong>3%</strong>.",
      pushViolet: "Over 1M points → extra <strong>5%</strong>.",
      advanceLadderAria: "Advance tier list",
