...
window.NOVYRA_I18N_MESSAGES = {
  en: {
    ...
    team: {
      ...
      bio: "Sets direction for partnerships, creator experience, and how the agency scales with {{iconTiktok}}’s LIVE ecosystem, with the same energy you see in the room with creators.",
    ...
    bonus: {
      ...
      recruitTitle: "Recruit bonus",
      recruitBody:
        "Anyone in the community can recruit and earn recruit bonuses when referred creators qualify.",
      pushLabel: "1M+ push",
